...
--Total cost incurred
Select sum(cogs)as Total_revenue from retail_sales

--Total profit earned
Select sum(total_sale - cogs) as Total_profit from retail_sales

-- Average sales amount per transaction 
select avg(total_sale) as Average_sale_per_transaction
from retail_sales
...
Select gender,avg(total_sale) as Average_sale_per_transaction
from retail_sales
group by gender
...
Select age, sum(total_sale) as Total_sales_by_age
from retail_sales
group by age 
