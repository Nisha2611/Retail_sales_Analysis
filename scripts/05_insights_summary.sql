...
-- Strategic Business Insights & Profitability Analysis

/*
1. Customer Segments with Highest Profit Margin by Age and Gender
*/
SELECT TOP 1 
    age,
    gender,
...
/*
2. Product Categories with High Sales but Below-Average Profit Margins
*/
...
/*
3. Hour of Day with Highest Profit
*/
SELECT TOP 1
...
/*
4. Day of the Week with Highest Profit Margin
*/
SELECT TOP 1
...
/*
5. Customers with High Revenue but Low Profit Margins
*/
...
/*
6. Most Profitable Category + Customer Segment Combinations
*/
SELECT
    category,
    customer_id,
...
/*
7. Prioritized Customer Segments & Product Categories for Marketing & Growth
*/
